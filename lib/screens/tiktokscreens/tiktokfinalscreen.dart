...
class TiktokFinalScreen extends StatefulWidget {
  final TiktokModel tiktokmodel;

  const TiktokFinalScreen({
    Key? key,
    required this.tiktokmodel,
  }) : super(key: key);

  @override
  State<TiktokFinalScreen> createState() => _TiktokFinalScreenState();
}

class _TiktokFinalScreenState extends State<TiktokFinalScreen> {
