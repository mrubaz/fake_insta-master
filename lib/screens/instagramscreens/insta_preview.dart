...
class PreviewInsta extends StatefulWidget {
  ...
  @override
  State<PreviewInsta> createState() => _PreviewInstaState();
}

class _PreviewInstaState extends State<PreviewInsta> {
      ...
      child: Column(children: [
          ...
          child: ListTile(
            ...
            leading: SizedBox(
              ...
              child: ClipRRect(
                ...
                child: widget.instagramModel.pickedProfile!.isEmpty
                    ? Container(
                        height: 50,
                        width: 50,
                        color: Colors.grey,
        ...
        GestureDetector(
          child: Container(
            ...
            width: 1080,
            child: widget.instagramModel.pickedPost!.isEmpty
                ? Container(
                    height: 500,
                    color: Colors.grey,
                  )
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Below Caption Area
              Text(
                "View all ${widget.instagramModel.comments!.toInt().toString()} comments",
                style: TextStyle(
                  fontSize: 13,
                  fontFamily: "helvetica-font",
                  fontWeight: FontWeight.w400,
